...
int main() {
  ...
  GLFWwindow *window = glfwCreateWindow(
      WINDOW_WIDTH, WINDOW_HEIGHT, "ECS-based Engine Demo", nullptr, nullptr);
  if (!window) {
  ...
  //     RenderComponent r; r.modelPath = "assets/models/example.obj"; r.model =
  //     resourceManager.loadModel(r.modelPath); world.addComponent(e, r);
  // }
